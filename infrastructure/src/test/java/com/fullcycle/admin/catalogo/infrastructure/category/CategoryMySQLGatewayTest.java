...
class CategoryMySQLGatewayTest {
    ...
    @Test
    public void givenPrePersistedCategories_whenCallsFindAll_shoudReturnPaginated(){
    ...
    @Test
    public void givenEmptyCategoriesTable_whenCallsFindAll_shoudReturnEmptyPage(){
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    public void givenFollowPagination_whenCallsFindAllWithPage1_shoudReturnPaginated(){
        var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 3;
    ...
    @Test
    public void givenPrePersistedCategoriesAndDocAsTerms_whenCallsFindAllAndTermsMatchCategoryName_shoudReturnPaginated(){
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchCategoryDescription_shoudReturnPaginated(){
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
