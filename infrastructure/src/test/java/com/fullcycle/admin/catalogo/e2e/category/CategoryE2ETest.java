...
public class CategoryE2ETest {
    ...
    private static final MySQLContainer MYSQL_CONTAINER =
            (MySQLContainer) new MySQLContainer("mysql:latest")
                    ...
                    .withStartupTimeoutSeconds(5*60);
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleSearchBetweenAllCategories() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToActivateCategoryByItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
