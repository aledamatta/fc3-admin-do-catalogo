...
public class GenreTest {
    ...
    public void givenInvalidNameWithLengthGreaterThan255_whenCallNewGenreAndValidate_shouldReceiveAError(){
        final var expectedName = """
            Gostaria de enfatizar que a competitividade nas transações comerciais faz parte de um
            processo de gerenciamento do impacto na agilidade decisória.
            Todavia, o julgamento imparcial das eventualidades cumpre um papel essencial na formulação
    ...
    @Test
    public void  givenADeactiveGenre_whenCallActivate_shouldReceiveOk(){
        final var expectedName = "Ação";
        final var expectedIsActive = true;
        final var expectedCategories = 0;
    ...
    @Test
    public void  givenAValidGenre_whenCallUpdateWithEmptyName_shouldReceiveNoticationException() {
        final var expectedName = " ";
        final var expectedIsActive = true;
        final var expectedCategories = List.of(CategoryID.from("123"));
        final var expectedErrorCount = 1;
    ...
    @Test
    public void  givenAValidGenre_whenCallUpdateWithNullName_shouldReceiveNoticationException() {
        final String expectedName = null;
        final var expectedIsActive = true;
        final var expectedCategories = List.of(CategoryID.from("123"));
        final var expectedErrorCount = 1;
