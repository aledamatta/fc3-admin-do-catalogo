...
class CategoryTest {
    ...
    @Test
    public void givenAValidEmptyDescription_whenCAllNewCategoryAndValidate_thenShouldNotReturnError(){
        final var expectedName = "Filmes";
    ...
    @Test
    public void givenAValidFalseIsActive_whenCAllNewCategoryAndValidate_thenShouldNotReturnError(){
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
