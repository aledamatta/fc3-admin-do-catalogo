...
public class ListCategoriesUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenAValidQuery_whenHasNoResults_thenShoudReturnEmptyCategories() {
    ...
    @Test
    public void givenAValidQuery_whenGatewayThrowsException_thenShoudReturnException() {
        final var expectedPage = 0;
        final var expectedPerPage = 10;
        final var expectedTerms = "";
        final var expectedSort = "createdAt";
